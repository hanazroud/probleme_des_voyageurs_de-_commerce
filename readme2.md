...
Ce projet implémente l'algorithme de **Recuit Simulé (Simulated Annealing)** pour résoudre le problème du **Voyageur de Commerce (TSP)** sur une matrice de distances entre 10 villes. Le but est de trouver le **chemin minimal** passant par toutes les villes exactement une fois et revenant au point de départ.
